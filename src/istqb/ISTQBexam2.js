  ...
  constructor(props) {
    ...
    this.state = {
      ...
      questions: [
          ...
          question: (
            <div>
              Which of the following statements about testing and quality management are correct?
            </div>
            ),
            options: [
          ...
          {//3
            question: (
              <div>
                Which of the following statements below describes the most common situation for a failure discovered during testing or in production?
              </div>
            ),
            options: [
          ...
          {//5
            question: (
              <div>
                Consider the following 4 test activities:
                <br/>
          ...
          question: (
            <div>
              Which of the following statements about test management roles are CORRECT?
            </div>
          ),
          options: [
            ...
            "d) Some of the test management tasks may be handled by the Agile team rather than by an individual"
          ],
          correctAnswer: "d) Some of the test management tasks may be handled by the Agile team rather than by an individual",
        },
        {//7
          question: (
            <div>
              Which of the following tasks occur during test completion?
              <br/>
              i. test basis is analyzed to identify testable features
              <br/>
              ii. testware that is useful in the future is archived
              <br/>
              iii. take the actions necessary to meet the objectives of the test plan
              <br/>
              iv. analyze completed test activities to identify lessons learned
              <br/>
        ...
        {//8
          question: (
            <div>
              During a project following Agile methods, you find a discrepancy between the developer's interpretation of an acceptance criteria and the product owner's interpretation, which you bring up during a user story refinement session.
              <br/>
        ...
        {//9
          question: (
            <div>
              Which of the following statements about good testing practices is CORRECT?
            </div>
          ),
          options: [
            "a) Test analysis and design for a given test level should begin after the corresponding development activity has been completed so that testing can adhere to the late testing principle",
            ...
            "d) Each test level should have test objectives specific to the appropriate SDLC phase so that testing can check the test object to the fullest extent possible"
          ],
          correctAnswer: "d) Each test level should have test objectives specific to the appropriate SDLC phase so that testing can check the test object to the fullest extent possible",
        },
        {//10
          question: (
            <div>
              Which of the following statements BEST describes the BDD (Behaviour-Driven Development) approach?
            </div>
          ),
          options: [
          ...
          question: (
            <div>
              You are reviewing an application design using a checklist. One of your checkpoints says: 'Are data flows within the system implemented correctly?'.
              <br/>
              Which type of testing is being applied?
            </div>
          ),
          options: [
        ...
        {//14
          question: (
            <div>
              Which of the following is a CORRECT example of the shift-left approach?
            </div>
          ),
          options: [
        ...
        {//15
          question: (
            <div>
              Which of the following statements about the benefits of early and frequent feedback are TRUE?
              <br/>
              1. Early feedback gives the developers less time to respond to quality problems
              <br/>
              2. Early feedback enables Agile teams to deliver features with the highest business value first
              <br/>
              3. Early feedback reduces costs because it decreases the amount of needed for regression testing
              <br/>
              4. Early feedback makes it more likely that the system built is what the customer wanted
            </div>
          ),
          options: [
            "a) 1 and 4",
        ...
        {//17
          question: (
            <div>
              You are reading a user story in the product backlog to prepare for a meeting with the product owner and a developer, noting potential defects as you go.
              <br/>
        ...
        {//18
          question: (
            <div>
              Which of the review types below is the BEST option to choose when the review must follow every stage in the formal process and collect metrics to improve the software development process?
            </div>
          ),
          options: [
            "a) Informal Review",
        ...
        {//19
          question: (
            <div>
              Prior to an iteration planning session, you are studying a user story and its acceptance criteria, deriving test conditions and associated test cases from the user story as a way of applying the principle of early QA and test.
              <br/>
              What test technique are you applying?
            </div>
          ),
          options: [
            "a) White-box",
        ...
        {//20
          ...
          question: (
            <div>
              ...
              <br/>
              While fixing the defect, a programmer asks you to recommend test techniques that are effective against this kind of defect.
              <br/>
              Which of the following test techniques would most likely have been able to detect the underlying defect?
            </div>
          ),
          options: [
            "a) Branch testing",
        ...
        {//22
          question: (
            <div>
              Which one of the following statements about error guessing is NOT correct?
            </div>
          ),
          options: [
        ...
        {//23
          question: (
            <div>
              Which one of the following descriptions of checklist-based testing is CORRECT?
            </div>
          ),
          options: [
        ...
        {//24
          question: (
            <div>
              A stakeholder has sketched out an initial idea for a user story 'As a bank teller, I would like to be able to view all of my customer’s bank transactions on the screen'.
              <br/>
              Which of the following statements about collaborative user story writing is CORRECT?
            </div>
          ),
          options: [
        ...
        {//25
          question: (
            <div>
              ...
              <br/>
              Given the following test cases (view the table below) - what is the minimum number of additional test cases that are needed to ensure 100% Each Choice coverage of the VALID INPUT equivalence partitions?
            </div>
          ),
          options: [
            "a) 1",
        ...
        {//27
          question: (
            <div>
              ...
              <br/>
              What is the minimum number of tests required to achieve 100% coverage of the decision table?
            </div>
          ),
          options: [
            "a) 2",
        ...
        {//28
          question: (
            <div>
              Consider the following state transition diagram for a credit-card only, unattended gasoline pump.<br/><br/>
              Assume that you want to develop the minimum number of tests to achieve all valid transitions coverage in the state transition diagram. Assume further that each test must start at the beginning state, waiting for the customer, and each test ends when a transition arrives at the beginning state.<br/><br/>
        ...
        {//29
          question: (
            <div>
              ...
              <br/>
              AC1: Only a bank teller will have access to a customer’s transaction history
              <br/>
              AC2: A customer's transaction history must be displayed on the screen in no more than 3 seconds from the request being submitted.
              <br/>
              The following Acceptance Test-driven tests have been identified:
              <br/>
              i. Login as a bank clerk, enter a customer account ID, attempt to get his transactions history on the screen
              <br/>
              ii. Login as a bank teller, enter a customer account ID to get his transactions history on the screen
              <br/>
              ...
              <br/>
              iv. Login as a Bank Teller, enter a customer Account ID, get the Transactions history in less than 3 seconds on screen.
              <br/>
              Which of the following is the CORRECT execution order for these tests?
            </div>
          ),
          options: [
            "a) i, ii, iii, iv",
        ...
        {//30
          question: (
            <div>
              Which of the following metrics are NOT used in testing?
            </div>
          ),
          options: [
          ...
          question: (
            <div>
              Given the following examples of entry and exit criteria for system testing:
              <br/>
              - The original testing budget of $30,000 plus contingency of $7,000 has been spent
              <br/>
              - 96% of planned tests for the drawing package have been executed, and the remaining tests are now out of scope
              <br/>
              - The trading performance test environment has been designed, set-up, and verified
              <br/>
              - Current status is no outstanding critical defects and two high-priority ones
              <br/>
              - The autopilot design specifications have been reviewed and reworked
              <br/>
              - The tax rate calculation component has passed unit testing
              <br/>
        ...
        {//32
          question: (
            <div>
              ...
              <br/>
              - TC1: Login as a bank teller. Enter customer ID. Verify that the customer transaction history is easy to find, and that navigating through the menus is intuitive
              <br/>
              - TC2: Login as a bank teller: Enter customer name. Verify that the customer accounts are easy to find and that navigating through the menus is intuitive
              <br/>
        ...
        {//33
          question: (
            <div>
              During product risk analysis of a mobile app, the following risk has been identified:
              <br/>
              Risk 21 Users find the soft keyboard too hard to use. The risk has been given a likelihood of low and an impact of low. The stakeholders have agreed not to test this risk.
              <br/>
              Which of the following CORRECTLY describes the product risk control action that has been taken?
            </div>
          ),
          options: [
            "a) Risk acceptance",
        ...
        {//34
          question: (
            <div>
              Which of the following is best at showing the team’s progress against estimated productivity rates?
            </div>
          ),
          options: [
            "a) Burndown charts",
        ...
        {//35
          question: (
            <div>
              Which of the following is NOT implemented as part of an automated DevOps pipeline?
            </div>
          ),
          options: [
          ...
          question: (
            <div>
              Your team is using the three-point estimation technique to estimate the testing effort for the next release. The consensus of the team is:
              <br/>
              - Most optimistic estimate 12 person days
              <br/>
              - Most likely estimate 18 person days
              <br/>
              - Most pessimistic estimate 36 person days
              <br/>
        ...
        {//37
          question: (
            <div>
              Given the following priorities and dependencies for these test cases (view below image) - which of the following test execution schedules BEST considers the priorities and technical and logical dependencies?
            </div>
          ),
          options: [
        ...
        {//38
          question: (
            <div>
              ...
              <br/>
              Which of this information is MOST useful to include in your defect report?
            </div>
          ),
          options: [
              "a) 1, 2, 6",
        ...
        {//39
          question: (
            <div>
              Which test activity do DevOps tools support?
            </div>
          ),
          options: [
            "a) Test execution",
        ...
        {//40
          question: (
            <div>
              Which of the following statements CORRECTLY identifies a potential benefit of test automation?
            </div>
          ),
          options: [
